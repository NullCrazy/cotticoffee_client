...
//             SensorsConstant.orderListToOrderDetailPage, {"status": widget.orderModel.status});
//       },
//       child: Container(
...
//                 current.pageIndex == widget.pageIndex;
//           },
...
//                 );
//                 SensorsAnalyticsFlutterPlugin.track(
//                     SensorsConstant.orderListCancelCommit, {"cancelId": p0.id});
//               },
//             );
//           },
...
//       );
//     }
//     if (widget.orderModel.appStatus == "WAIT_BUYER_CONFIRM_GOODS" &&
//         widget.orderModel.eatType == 3 &&
//         expressMode()) {
//       list.add(
//         _buildBtn(
//           "查看物流",
...
//             NavigatorUtils.push(
//               context,
//               OrderRouter.logistics,
//               arguments: widget.orderModel.orderExpress,
//               params: {"expressMode": widget.orderModel.expressMode},
//             );
//           },
//         ),
//       );
...
//       onTap: () {
//         callback();
//         SensorsAnalyticsFlutterPlugin.track("orderList_${PinyinHelper.getShortPinyin(text)}", null);
//       },
//       child: Container(
...
//         } else {
//           ABiteLog.d(payResult.msg);
//         }
//         SensorsAnalyticsFlutterPlugin.track(SensorsConstant.orderListToPay, {
//           "shopMdCode": widget.orderModel.shopMdCode,
//           "shopName": widget.orderModel.shopName,
//           "payResult": "${payResult.state}",
//         });
//       },
//     );
//     SensorsAnalyticsFlutterPlugin.track(SensorsConstant.orderListToPay, null);
//   }
//
