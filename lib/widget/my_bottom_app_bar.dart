...
///
/// {@tool dartpad}
/// This example shows the [MyBottomAppBar], which can be configured to have a notch using the
/// [MyBottomAppBar.shape] property. This also includes an optional [FloatingActionButton], which illustrates
/// the [FloatingActionButtonLocation]s in relation to the [MyBottomAppBar].
///
...
/// See also:
///
///  * [NotchedShape] which calculates the notch for a notched [MyBottomAppBar].
///  * [FloatingActionButton] which the [MyBottomAppBar] makes a notch for.
...
class MyBottomAppBar extends StatefulWidget {
  ...
  /// The margin between the [FloatingActionButton] and the [MyBottomAppBar]'s
  /// notch.
  ///
